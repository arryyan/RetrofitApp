...
import com.example.retrofitapp.api.ServiceApi;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView textOutput, textInput2;
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(fileName) && selectedImg != null) {
                    ...
                    String a = textInput.getText().toString();
        ...
        call.enqueue(new Callback<HashMap<String, String>>() {
            ...
            public void onResponse(Call<HashMap<String, String>> call, Response<HashMap<String, String>> response) {
                if (response.body() == null) {
                    ...
                    Log.i("RESPONSE_BODY", response.body().toString());
